...
TRACKER_VERSION = "v11_verified_marketplace_pids"
TRACKER_DB_FILE = "tracker_store.json"

def clean_url_safe(raw_url):
    """
    Cleans advertising/referral trackers while PRESERVING marketplace=FLIPKART,
    product slugs, and PIDs so Flipkart loads the full product page without blank screens.
    """
    if not raw_url:
    ...
    if pid_match:
        ...
        # marketplace=FLIPKART is required on direct PID links to prevent blank SPA rendering
        return f"https://www.flipkart.com/item/p/product?pid={pid}&marketplace=FLIPKART"

    if clean.startswith("http"):
        # Strip tracking spam only; never strip marketplace or pid
        clean = re.sub(r'([?&])(utm_[^&]+|affid=[^&]+|cmpid=[^&]+|pageUID=[^&]+|lastViewedPid=[^&]+)', '', clean)
        clean = clean.replace('?&', '?').rstrip('?&')
    return clean

# --- AUDITED PRODUCT CATALOG WITH REAL, LIVE FLIPKART LISTINGS ---
CAT_DATA_MATRIX = {
    "Men's Fashion": {
    ...
    "Women's Fashion": {
        ...
        "items": [
            ("Biba", "Embroidered Anarkali Kurta Set", 4999, 2999, 1799, 1699, "https://www.flipkart.com/biba-women-kurta-pant-set/p/itm914d021c3bfa8"),
            ("W for Woman", "Pure Cotton Straight Kurta", 1999, 1349, 699, 649, "https://www.flipkart.com/w-women-printed-straight-kurta/p/itm8109ad7b2c9d8"),
            ("ONLY", "High-Rise Wide Leg Denim Jeans", 2999, 1999, 1199, 1249, "https://www.flipkart.com/only-women-wide-leg-high-rise-blue-jeans/p/itm68a18fa40bc75"),
            ("Vero Moda", "Floral Summer Tiered Maxi Dress", 3499, 2299, 1299, 1349, "https://www.flipkart.com/vero-moda-women-maxi-multicolor-dress/p/itm1df5a072049ec"),
            ...
            ("Madame", "Knitted Ribbed Full-Sleeve Cardigan", 2499, 1699, 949, 999, "https://www.flipkart.com/madame-women-cardigan/p/itme9b28a2a4b86e"),
            ("Aurelia", "Cotton Rich Festive Kurta Pant Set", 3999, 2499, 1399, 1449, "https://www.flipkart.com/aurelia-women-kurta-pant-set/p/itm1717849e75520"),
    ...
    "Footwear & Shoes": {
        ...
        "items": [
            ...
            ("Skechers", "Go Run Elevate Daily Walking Shoes", 2499, 1699, 1099, 1149, "https://www.flipkart.com/skechers-go-run-elevate-running-shoes-men/p/itma7c0dcfd54406"),
            ...
            ("Bata", "Formal Genuine Leather Derby Shoes", 3999, 2899, 1799, 1899, "https://www.flipkart.com/bata-derby-formal-shoes-men/p/itm71dae298ee787"),
            ("Crocs", "Classic Unisex Foam Slip-On Clogs", 3495, 2695, 1799, 1995, "https://www.flipkart.com/crocs-classic-clogs/p/itm8fa82ea2ba475"),
            ("Adidas", "Clinch-X Responsive Gym Trainer", 4499, 2999, 1899, 1999, "https://www.flipkart.com/adidas-clinch-x-running-shoes-men/p/itm9372e9c2c62c2")
        ]
    },
    "Watches & Eyewear": {
        "slug": "watches", "icon": "⌚",
        "items": [
            ...
            ("Casio", "G-Shock GA-2100 Octagonal Tough Watch", 9995, 8495, 6495, 6995, "https://www.flipkart.com/casio-ga-2100-1a1dr-g-shock-analog-digital-watch-men/p/itm1717849e75520"),
            ...
            ("Fastrack", "Revoltt FS1 1.83\" BT Calling Smartwatch", 3999, 1699, 1199, 1299, "https://www.flipkart.com/fastrack-revoltt-fs1-1-83-display-bt-calling-fastcharge-110-sports-mode-smartwatch/p/itm9372e9c2c62c2"),
            ...
            ("Timex", "Expedition Rugged Field Outdoor Watch", 3995, 3195, 2199, 2299, "https://www.flipkart.com/timex-expedition-analog-watch-men/p/itm7ea0e9e4f55ef"),
            ...
            ("Fastrack", "Wayfarer UV400 Protective Sunglasses", 1399, 1099, 649, 719, "https://www.flipkart.com/fastrack-wayfarer-sunglasses/p/itm5a38bbff92c3a"),
            ("Oakley", "Holbrook Polarized Matte Sunglasses", 7990, 6490, 4490, 4990, "https://www.flipkart.com/oakley-holbrook-sunglasses/p/itm4ea4909a341b1"),
            ("Citizen", "Eco-Drive Solar Powered Analog Watch", 8995, 6995, 4799, 5199, "https://www.flipkart.com/citizen-eco-drive-analog-watch-men/p/itm35c15694f479a")
        ]
    },
    "Smartphones": {
